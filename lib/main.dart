      ...
      return MultiProvider(
        providers: [
          ...
          ChangeNotifierProvider<RecipeProvider>(create: (_) => RecipeProvider(
              ...
              getRecipesStreamUseCase: GetRecipesStream(recipeRepository),
              getFavoriteRecipesStreamUseCase: GetFavoriteRecipesStream(recipeRepository),
              getAllLocalFavoriteRecipesUseCase: GetAllLocalFavoriteRecipesUseCase(recipeRepository),
              setFavoriteStatusUseCase: SetFavoriteStatusUseCase(recipeRepository),
              addFavoriteRecipeUseCase: AddFavoriteRecipeUseCase(recipeRepository),
              removeFavoriteRecipeUseCase: RemoveFavoriteRecipeUseCase(recipeRepository),
          )),
